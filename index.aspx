<%@ Page Language="C#" AutoEventWireup="true" UnobtrusiveValidationMode ="none" CodeBehind="index.aspx.cs" Inherits="web_project.WebForm1" %>
    ...
    <form id="form1" runat="server">
         ...
         <div id="navbar" class="collapse navbar-collapse"> 
            ...
            <ul class="navbar-nav ">
                ...
                <asp:Button ID="Button1" runat="server" Text="SIGN IN" class="btn btn-outline-secondary btn-signin" ValidationGroup="signin" />
            ...
            <video autoplay muted loop id="bg-video">
                ...
                <div class="row">
                    <div class="col-lg-8 m-3">
                        ...
                        <asp:Button ID="Button2" runat="server" Text="SIGN IN" class="btn btn-outline-secondary signin-btn " ValidationGroup="signin" />
          ...
          <div class="form-box signin">
           ...
           <!--   <form action="#" method="post"> -->
                  <div class="input-box">
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="email" ValidationGroup="signin" ></asp:RequiredFieldValidator>
                  </div>
                  <div class="input-box">
                      <asp:TextBox ID="password" runat="server" placeholder="Password" name="password" minlength="6"></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="password" ValidationGroup="signin"></asp:RequiredFieldValidator>
                  </div>
              <asp:Button ID="login_btn" runat="server" Text="Sign in" class="sign-btn" CausesValidation="true" ValidationGroup="signin" OnClick="login_btn_Click" />
        ...
        <!--      </form>  -->
            ...
            <div class="form-box signup">
              ...
              <!--  <form action="#" method="post"> -->
                    <div class="input-box">
                        <asp:TextBox ID="username_txt" runat="server"  placeholder="Username" ></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="username_txt" ValidationGroup="signup"></asp:RequiredFieldValidator>
                    </div>
                    <div class="input-box">
                        <asp:TextBox ID="email_txt" runat="server"  placeholder="Email"></asp:TextBox>
         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"  ErrorMessage="*" ForeColor="Red" ControlToValidate="email_txt" ValidationGroup="signup"></asp:RequiredFieldValidator>
                    </div>
                    <div class="input-box">
                        <asp:TextBox ID="pass_txt" runat="server"  placeholder="Password" minlength="6"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="pass_txt" ValidationGroup="signup"></asp:RequiredFieldValidator>
                    </div>
                    <asp:Button ID="signup_btn" runat="server" Text="Sign up" class="sign-btn" OnClick="signup_btn_Click1" CausesValidation="true"  ValidationGroup="signup"/>
        ...
        <section id="courses" class="h-courses">
            <div class="container">
                ...
                <div class="collapse" id="cards">
                    ...
                    <div class="see-all">
                        <asp:HyperLink ID="HyperLink1" runat="server" href="Courses.aspx">See all</asp:HyperLink>
